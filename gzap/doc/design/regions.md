...
qualifier is required, and can be any of the following:
- `need`, meaning that the weapon is logically required for this check or region
  under all circumstances;
- `want`, meaning that the weapon is strongly recommended, and will be logically
  required if any form of combat logic is enabled, which is the default;
- `auto`, meaning that the weapon should be required if autogenerated combat
  logic is on and off otherwise.
