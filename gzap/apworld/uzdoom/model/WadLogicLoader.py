...
class WadDataLoader:
    ...
    def print_stats(self) -> None:
        ...
        nrof_spheres = self.wad.sphere_count()
        ...
        print("\x1B[1m%32s: %2d maps, %4d monsters; %4d monsters/map; %d checks%s\x1B[0m" % (
            self.wad.name, nrof_maps, nrof_monsters, nrof_monsters//nrof_maps,
            len(list(self.wad.all_locations())),
            f" in {nrof_spheres} spheres" if nrof_spheres > nrof_maps else ""))
