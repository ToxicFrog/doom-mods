...
⚠️ YAML and in-game settings have changed. Generate new template YAMLs and
...
the randomizer code itself. Support for individual WADs has been split into
[individual apworlds per wad](../release/apworlds), which have their own YAMLs.
See the [support table](doc/support-table.md) for a complete list.
